...
public abstract class AbstractController implements CommandListener, ControllerInterface {
	...
	protected abstract boolean handleCommand(Command command) throws NullAlbumDataReference, PersistenceMechanismException, InvalidImageDataException, UnavailablePhotoAlbumException, MediaNotFoundException;

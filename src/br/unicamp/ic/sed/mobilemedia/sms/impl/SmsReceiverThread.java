		...
		while(true){
			...
			try {
				...
				*/
				...
				handler.handle( new InterruptedIOException( "Error Incoming Photo: You have just received a bad fragmentated photo which was not possible to recovery." ));
				//continue;
				...
				*/
				IManager manager = ComponentFactory.createInstance();
				IExceptionHandler handler = (IExceptionHandler) manager.getRequiredInterface("IExceptionHandler");
				handler.handle( new IOException( "Error Incoming Photo: You have just received a bad fragmentated photo which was not possible to recovery." ));
				//continue;
